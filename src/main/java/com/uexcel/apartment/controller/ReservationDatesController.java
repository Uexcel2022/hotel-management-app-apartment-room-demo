...
@Tag(name = "REST APIs For Apartment  Reservation Dates.",
        description = "The REST APIs For Apartment Reservation Dates CRUD operations.")
@RestController
...
public class ReservationDatesController {
    ...
    @Operation(summary = "The API Delete Apartment Reservation Dates ",
    ...
    @Operation(summary = "The API to Fetch Apartment Reservation Dates. ",
            description = "The API to Fetch Customer's Apartment Reservation  by Phone Number'.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",description = "Ok",
    ...
    public ResponseEntity<ResponseDto> updateReservationDates(@RequestBody List<ReservationDates> reservationDates ){
        ...
        reservationDates.forEach(reservationDate -> {
            ...
            dt.setApartment(reservationDate.getApartment());
            rsvDate.add(dt);
        });
